...
* Support for clearing 3rd party WP e-Commerce Plugins; Custom Fields, Related Products, Add to Wishlist, Product Enquiry, etc.
...
* Additional Sales detail columns (e.g. Status Indicator, Session ID, IP Address, etc.)
